...
public class Homepage extends BasePage {
	...
	By inactiveSidebar = By.className("inactive");
	...
	public boolean getInactiveSidebar() {
		return Arrays.asList(driver.findElement(inactiveSidebar).getAttribute("class").split(" ")).contains("inactive");
	}
